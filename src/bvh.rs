...
impl BVHNode {
    ...
    pub fn new(objects: &mut Vec<Rc<dyn Hittable>>, start: usize, end: usize) -> Self {
        ...
        if object_span == 1 {
            ...
            right = Rc::new(BVHNode::new(objects, start, mid));
        }
...
fn box_compare<'h1, 'h2>(a: &'h1 Rc<dyn Hittable>, b: &'h2 Rc<dyn Hittable>, axis_index: usize) -> Ordering {
...
fn box_x_compare<'h1, 'h2>(a: &'h1 Rc<dyn Hittable>, b: &'h2 Rc<dyn Hittable>) -> Ordering {
    return box_compare(a, b, 0);
}

fn box_y_compare<'h1, 'h2>(a: &'h1 Rc<dyn Hittable>, b: &'h2 Rc<dyn Hittable>) -> Ordering {
    return box_compare(a, b, 1);
}
fn box_z_compare<'h1, 'h2>(a: &'h1 Rc<dyn Hittable>, b: &'h2 Rc<dyn Hittable>) -> Ordering {
